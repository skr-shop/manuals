...
CREATE TABLE `auth_ms_map` (
    ...
    `create_at` varchar(12) NOT NULL DEFAULT '' COMMENT '创建时间',
    `create_by` int(11) NOT NULL DEFAULT '' COMMENT '创建人staff_id',
    `update_at` varchar(12) NOT NULL DEFAULT '' COMMENT '更新时间',
    `update_by` int(11) NOT NULL DEFAULT '' COMMENT '修改人staff_id',
...
CREATE TABLE `auth_role` (
    ...
    `auth_item_set` varchar(255) NOT NULL DEFAULT '0' COMMENT '权限集合 多个值,号隔开',
    `create_at` varchar(12) NOT NULL DEFAULT '' COMMENT '创建时间',
    `create_by` int(11) NOT NULL DEFAULT '' COMMENT '创建人staff_id',
    `update_at` varchar(12) NOT NULL DEFAULT '' COMMENT '更新时间',
    `update_by` int(11) NOT NULL DEFAULT '' COMMENT '修改人staff_id',
